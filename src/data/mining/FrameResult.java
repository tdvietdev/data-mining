...
public class FrameResult extends javax.swing.JFrame {
     ...
     */
    public FrameResult(Map<Set<String>, Integer> frequentItemSets) {
        serviceImpl = new APriori<>();
        this.frequentItemSets = frequentItemSets;
        this.confidence = confidence;
        initComponents();
        lbResult.setHorizontalAlignment(SwingConstants.CENTER);
        lbResult.setVerticalAlignment(SwingConstants.CENTER);
    }
    ...
    private void initComponents() {
        ...
        jsResult.setViewportView(lbResult);

        btnSupport.setText("Xem support");
        ...
        btnConfidence.setText("Xem Confidence");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(jsResult, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnConfidenceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfidenceActionPerformed
        ...
        lbResult.setText(serviceImpl.resultOfConfidence(frequentItemSets,this.confidence));
    ...
    private void btnSupportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupportActionPerformed
        ...
        lbResult.setText(serviceImpl.printCandidatesResult(frequentItemSets));
